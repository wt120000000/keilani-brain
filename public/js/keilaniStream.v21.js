/* keilaniStream.v21.js */
(() => {
  console.log("[keilani] boot v21");
  ...
  function stopAudio(){
    if (currentAudio){
      ...
      // do NOT set src="" (avoids "Invalid URI" warning)
  ...
  // ---------- VAD loop (FIXED: silence detection) ----------
  function startListening(){
    ...
    const tick=()=>{
      ...
      const isHot = (micRms > thr) && micBeatsOutput;
      ...
      // ⬇⬇ FIX: only refresh lastSound when the mic is hot
      if (voiced && isHot) lastSound = now;
